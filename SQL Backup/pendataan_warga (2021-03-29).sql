...
CREATE TABLE `reports` (
  ...
  `report_birth_place` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_birth_date` date NOT NULL,
  `report_address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_rt` int(11) NOT NULL,
  `report_rw` int(11) NOT NULL,
  `report_phone` varchar(16) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_job` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_province` bigint(20) UNSIGNED NOT NULL,
  `report_district` bigint(20) UNSIGNED NOT NULL,
  `report_duration` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_purpose` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `report_health_status` enum('sehat','sakit') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `reports` (`report_id`, `report_nik`, `report_name`, `report_sex`, `report_birth_place`, `report_birth_date`, `report_address`, `report_rt`, `report_rw`, `report_phone`, `report_job`, `report_province`, `report_district`, `report_duration`, `report_purpose`, `report_health_status`, `created_at`, `updated_at`) VALUES
(1, '3212132507010001', 'Didi Abdillah', 0, 'Indramayu', '2001-07-25', 'Blok Desa', 5, 2, '081564678102', 'Mahasiswa', 34, 3404, '5 Bulan', 'Magang', 'sehat', '2021-03-28 15:46:54', '2021-03-28 15:46:54');
...
('a5c860decf204ea686aedbb6dbeb6ab1', 'Didi', 'abdillah1965didiokey@gmail.com', '$2y$10$H/KIpEWYNPUGfRrMCi4HRe4sQSQd7PjI5QURxUdzNILKztS5Dujnm', '087727598653', 'admin', 'default.jpg', '2021-03-28 15:20:47', '2021-03-28 15:20:47');
